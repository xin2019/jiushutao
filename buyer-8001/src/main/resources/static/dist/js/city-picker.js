...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['static/dist/js/jquery', 'ChineseDistricts'], factory);
    } else if (typeof exports === 'object') {
        // Node / CommonJS
        factory(require('static/dist/js/jquery'), require('ChineseDistricts'));
    } else {
        // Browser globals.
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    (this.includeDem('city') ? '<a data-count="city">学校</a>' : '') +
